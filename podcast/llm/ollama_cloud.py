...
def call(
    ...
    base_url = config.get("llm", {}).get("providers", {}).get("ollama_cloud", {}).get("base_url", DEFAULT_BASE_URL).rstrip("/")
    ...
    timeout = config.get("llm", {}).get("providers", {}).get("ollama_cloud", {}).get("timeout", 300)
